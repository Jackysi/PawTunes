    ...
    if ( !empty( $_POST ) ) {
        ...
        if ( empty( $_POST[ 'name' ] ) ) {
            ...
            if ( !empty( $_FILES[ 'logo' ][ 'tmp_name' ] ) ) {
                ...
                } else if ( !in_array( $pawtunes->extGet( $up[ 'path' ] ), $logo_ext ) ) {
            ...
            for ( $i = 0; $i <= $c; $i++ ) {
                ...
                for ( $f = 0; $f <= $totalFields; $f++ ) {
                    ...
                    } else if ( in_array( $pawtunes->extGet( $_POST[ $name ][ $f ] ), $streamUrlExt ) ) { // Check if stream URL is a playlist
            ...
            } else if ( isset( $channels ) && is_array( $channels ) && empty( $error ) ) { ## Merge new channels with existing ones
            ...
            } else if ( $panel->storeConfig( 'config/channels', $confOut ) ) {
